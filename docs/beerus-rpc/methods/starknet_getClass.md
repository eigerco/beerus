...
- [starknet_getClass](https://github.com/starkware-libs/starknet-specs/blob/e0b76ed0d8d8eba405e182371f9edac8b2bcbc5a/api/starknet_api_openrpc.json#L248)
...
```json
{
  ...
  "params":["tag", "latest", "0x02a5de1b145e18dfeb31c7cd7ff403714ededf5f3fdf75f8b0ac96f2017541bc"],
  "id":0
}
```
